                ...
                Row(verticalAlignment = Alignment.CenterVertically, modifier = Modifier.weight(1f)) {
                    ...
                    Column(
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            val nameColor by animateColorAsState(if (isCollapsed) Color.White.copy(0.6f) else Color.White, label = "nameColor")
                            Text(
                                text = player.name,
                                fontSize = 14.sp,
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            val stackColor by animateColorAsState(if (isCollapsed) Emerald400.copy(0.6f) else Emerald400, label = "stackColor")
                            Text(
...
if match:
    ...
    # Also fix the closing bracket of the bottom Row that is now inside a Column
    # The end of PlayerCardCompact looks like:
    #                     }
    #                 }
    #             }
    #         }
    ...
    # Because we opened an AnimatedVisibility and a Column, we need to add two more closing braces.
    # We will just replace the end of the function.
    end_pattern = re.compile(r"                                        Text\(\"P\", fontSize = 14\.sp, fontWeight = FontWeight\.Black\)\n                                    \}\n                                \}\n                            \}\n                        \}\n                    \}\n                \}\n            \}\n        \}\n    \}\n\}")
    
    end_replacement = """                                        Text("P", fontSize = 14.sp, fontWeight = FontWeight.Black)
                                    }
                                }
                            }
                        }
...
"""
    new_content = end_pattern.sub(end_replacement, new_content)
